...
func _process(delta: float) -> void:
	...
	environment.sky.sky_material.set_shader_parameter('_MoonWorldToObject', moonBasis.inverse()); # The world to object matrix is the inverse of the basis (which is object to world)
	pass
